package com.diffusion.training.essentials;
 ...
 * @since 5.7
 */
public abstract class BasicDiffusionClient {
    private static final Logger LOG = LoggerFactory
            .getLogger(BasicDiffusionClient.class);
     ...
     */
    public BasicDiffusionClient(String url, String principal) {
        this.url = url;
        ...
        Diffusion.sessions()
                ...
                .listener(new Session.Listener() {
                    ...
                    public void onSessionStateChanged(
                        ...
                        synchronized (BasicDiffusionClient.this) {
